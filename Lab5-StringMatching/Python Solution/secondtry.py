...
def align_words_rec(string1, string2, result1, result2, total_gain):
    ...
    if (string1, string2, result1, result2) in align_cache:
        ...
        if length1 == 1 and length2 == 1:   # base case 1
            ...
            # decide on which side of letter2 we put '*'
            left_gain = gain(string1[1], letter2)
            right_gain = gain(string1[0], letter2)
            ...
            if left_gain > right_gain:
                ...
                total_gain = right_gain
                string1_result = string1
                string2_result = string2 + '*'

        elif length1 == 1 and length2 > 1:  # base case 3
            # decide on which side of letter2 we put '*'
            left_gain = gain(letter1, string2[1])
            right_gain = gain(letter1, string2[0])
